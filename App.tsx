      ...
      <div
        ...
        style={{
          background: `radial-gradient(600px at ${
            isMobile ? "0px 0px" : `${mousePosition.x}px ${mousePosition.y}px`
          }, ${
                    ...
                    >
                      <span
                        className={`h-[1px] bg-current transition-all duration-300 ${
                          activeSection === item.id
                            ? "w-8 md:w-12"
                            : "w-4 md:w-8 opacity-50 group-hover:w-12 group-hover:opacity-100"
                        }`}
                      ></span>
            ...
            >
              ...
              <div className="flex-1 text-base leading-relaxed text-gray-800 dark:text-gray-400">
                <p>
                  ...
                  products. I’m passionate about learning, taking on new
                  challenges, and building things that genuinely help people.
                  I'm a fan of and enjoy using AI to accelerate my learning and
                  streamline workflows, but never as a crutch. Outside of tech,
                  I stay active through baseball, the gym, biking, running, and
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {project.highlightTags &&
                          project.highlightTags.map((tag, index) => (
                            <span
                              key={`highlight-${index}`}
